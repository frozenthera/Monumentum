...
namespace Gamekit3D
{
    ...
    public class TransitionStartEditor : Editor
    {
        ...
        SerializedProperty m_OnStartTransition;
        ...
        void OnEnable()
        {
            ...
            m_OnStartTransition = serializedObject.FindProperty("OnStartTransition");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_OnStartTransition);
